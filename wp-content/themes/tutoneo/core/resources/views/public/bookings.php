                        ...
                        <div class="block-booking shadow-lg border-smooth card-pd-30 border-radius-standard">
                            ...
                            <div class="row">
                                <div class="col-md-12 form-group text-center">
                                    ...
                                    <?php echo __('This booking is on hold as it is awaiting payment from the student') ?>
                                    </span>
                                </div>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="row form-group">
                                <div class="col-12">
                                    ...
                                    <a target="_blank" href="<?php echo $booking->get_payment_link() ?>" class="btn btn-success btn-xs mr-3">
                                        <?php echo __('Pay Now') ?>
                                    </a>
                                    <?php endif; ?>
                                    ...
                                    <a href="javascript:;"
                                        data-booking="<?php echo $booking->get_reference() ?>"
                                        class="btn btn-primary btn-xs mr-3 show-dominant-memory-modal">
                                    ...
                                    <a href="javascript:;"
                                        data-booking="<?php echo $booking->get_reference() ?>"
                                        class="btn btn-primary btn-xs show-student-questionnaire-response">
                                    ...
                                    <a href="javascript:;"
                                        data-booking="<?php echo $booking->get_reference() ?>"
                                        class="btn btn-danger btn-xs cancel-booking float-right">
                                        <?php echo __('Cancel') ?>
                                    </a>
                                    <?php endif; ?>
                                </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="card bg-gray-300">
                                                            ...
                                                            <div class="card-footer">
                                                                <div class="text-center">
                                                                    <a href="javascript:;"
                                                                        data-lesson="<?php echo $lesson->get_reference() ?>" 
                                                                        data-start="<?php echo $lesson->get_start_time() ?>" 
                                                                        class="btn btn-xs btn-primary lesson-action">
