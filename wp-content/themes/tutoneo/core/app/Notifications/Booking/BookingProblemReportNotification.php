...
class BookingProblemReportNotification extends Notification
{
    private $booking;
    private $message;
    private $template;
    ...
    public function __construct(Booking $booking, $message)
    {
        ...
        $this->template = new EmailTemplateService(EmailTemplate::find_by_type(EmailTemplate::BOOKING_PROBLEM_REPORT));
