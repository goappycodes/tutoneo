...
class MatchNotFoundNotification extends Notification
{
    private $booking;
    private $template;
    ...
    public function __construct(Booking $booking)
    {
        ...
        $this->template = new EmailTemplateService(EmailTemplate::find_by_type(EmailTemplate::MATCH_NOT_FOUND_USER));
