...
class LessonCompletedTeacherNotification extends Notification
{
    private $lesson;
    private $template;
    ...
    {
        $this->lesson = $lesson;
        $this->template = new EmailTemplateService(EmailTemplate::find_by_type(EmailTemplate::LESSON_COMPLETION_TEACHER));
